...
INSERT INTO `automobili` (`broj_sasije`, `naziv_automobila`, `cijena`, `klase_automobila_klasa_id`, `brendovi_automobila_brend_id`, `opreme_oprema_id`) VALUES ('GHFTZ278','Audi TT',100000.00,5,3,2),('HJ6147JDF','VW Passat 7',40000.00,2,1,4),('MG6947JD','Renault Talisman',30000.00,5,6,3),('NHZT5678','Mercedes GLE 220',70500.00,1,2,1),('U65077DH','VW Golf 6 TDI',50000.00,5,1,2),('U6947JDH','Audi Q3',60360.00,1,3,1),('ZU6247JD','VW Tiguan',38000.00,1,1,2),('ZU673GHA','Renault Cupra',50000.00,3,6,1);
...
INSERT INTO `brendovi_automobila` (`brend_id`, `naziv_brenda`) VALUES (1,'VW'),(2,'Mercedes'),(3,'Audi'),(4,'Seat'),(5,'AlfaRomeo'),(6,'Renault'),(7,'Peugeot'),(8,'Dacia'),(9,'Citroen'),(10,'Lancia');
...
INSERT INTO `fakture` (`datum`, `nacin_placanja_nacin_placanja_id`, `prodaje_faktura_id`, `uposlenici_uposlenik_id`) VALUES ('2020-03-01',2,1,3),('2020-02-05',2,2,4),('2020-02-01',1,3,3),('2020-02-11',3,4,4),('2020-04-12',4,5,3),('2020-04-15',3,6,4),('2020-06-12',2,7,3),('2020-06-15',4,8,4);
...
INSERT INTO `klase_automobila` (`klasa_id`, `naziv_klase`) VALUES (1,'SUV'),(2,'Karavan'),(3,'Limuzina'),(4,'Roadster'),(5,'Coupe');
...
INSERT INTO `nacin_placanja` (`nacin_placanja_id`, `naziv_nacin_placanja`) VALUES (1,'na_rate'),(2,'gotovina'),(3,'lizing'),(4,'karticno');
...
INSERT INTO `opreme` (`oprema_id`, `tip_opreme`) VALUES (1,'Sport'),(2,'R-Line'),(3,'Style'),(4,'Advanced');
...
INSERT INTO `poslovnice` (`poslovnica_id`, `naziv_poslovnice`, `grad`, `adresa`, `telefon`, `profit`, `uposlenik_id`, `radno_vrijeme`, `automobili_broj_sasije`) VALUES (1,'SarajevoExpertStup','Sarajevo','Hifzi Bjelavca 11','033 456768',140000.00,1,'08:00-16:00','GHFTZ278'),(2,'SarajevoExpertOtes','Sarajevo','Prijedorska 27','033 654768',120000.00,3,'08:00-16:00','HJ6147JDF'),(4,'MostarExpert','Mostar','Maršala Tita 2','033 456832',90000.00,2,'08:00-16:00','MG6947JD');
...
INSERT INTO `prodaje` (`faktura_id`, `komentar`, `poslovnice_poslovnica_id`, `automobili_broj_sasije`, `kupci_kupac_id`, `uposlenici_uposlenik_id1`) VALUES (1,'/',1,'GHFTZ278',1,3),(2,'/',2,'HJ6147JDF',2,4),(3,'/',4,'MG6947JD',3,4),(4,'/',1,'NHZT5678',4,3),(5,'/',2,'U65077DH',5,3),(6,'/',1,'U6947JDH',6,4),(7,'/',4,'ZU6247JD',7,3),(8,'/',1,'ZU673GHA',8,3);
...
-- Dump completed on 2020-12-23  3:13:09
